...
export default async function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center">
      ...
      {/* Hero Section */}
      <section className="relative w-full overflow-hidden bg-linear-to-br from-primary/90 to-accent text-white px-6 pt-32 pb-20 lg:pt-48 lg:pb-32 flex flex-col items-center text-center">
        ...
        <div className="relative z-10 max-w-3xl space-y-6">
          <Badge
            variant="secondary"
            className="bg-white/20 hover:bg-white/30 text-white border-none backdrop-blur-md px-4 py-1.5 text-sm rounded-full animate-in fade-in slide-in-from-top-4 duration-500"
          >
          ...
          <p className="text-lg lg:text-xl text-primary-foreground/80 max-w-xl mx-auto font-medium animate-in fade-in slide-in-from-top-8 duration-1000">
            Conecte-se com especialistas verificados em sua área. Rápido,
            confiável e seguro.
          </p>
          ...
          <div className="mt-12 p-2 bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl flex flex-col sm:flex-row gap-2 max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-10 duration-1000">
            ...
            <div className="hidden sm:block w-px bg-white/20 my-3" />
            <div className="flex-1 relative">
            ...
            <Button
              size="lg"
              className="w-full sm:w-auto h-14 px-10 rounded-2xl bg-white text-primary hover:bg-white/90 font-black shadow-lg transition-transform active:scale-95"
            >
              Buscar
            </Button>
          </div>
      ...
      <section className="w-full max-w-7xl px-6 py-24">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
          <div className="text-center md:text-left">
            ...
            <p className="text-muted-foreground mt-3 text-lg">
              Especialistas altamente avaliados prontos para ajudar.
            </p>
          </div>
          <Link href="/explore">
            <Button
              variant="ghost"
              className="text-primary hover:text-accent font-bold h-12 px-6 rounded-xl border border-primary/10"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="p-8 flex gap-5 items-start">
                <div className="relative">
                  <img
                    src={
                      ...
                      `https://ui-avatars.com/api/?name=${encodeURIComponent(provider.profiles.full_name)}&background=0E5D91&color=fff`
                    }
                ...
                <div className="flex-1 pt-1">
                  ...
                  <p className="text-sm text-primary font-bold mt-1 uppercase tracking-wider">
                    {provider.profession_title || "Profissional"}
                  </p>
                  ...
                  <div className="flex items-center gap-1.5 mt-3">
                    <div className="flex items-center gap-0.5">
                      {[1, 2, 3, 4, 5].map((s) => (
                        <Star
                          key={s}
                          className={`w-3.5 h-3.5 ${s <= Math.floor(provider.rating || 0) ? "fill-yellow-400 text-yellow-400" : "text-muted fill-muted"}`}
                        />
                      ))}
                    </div>
          ...
          <Link
            href="/explore"
            className="group relative bg-linear-to-br from-primary/5 to-accent/5 rounded-[32px] border border-dashed border-primary/30 flex flex-col items-center justify-center p-8 text-center hover:border-primary/60 transition-all duration-500 cursor-pointer min-h-[220px]"
          >
            ...
            <p className="text-sm text-muted-foreground mt-2 font-medium">
              Encontre exatamente quem você precisa em nossa rede.
            </p>
          </Link>
        </div>
      </section>
      ...
      <section className="w-full bg-primary/5 py-32 border-y border-primary/10">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto font-medium leading-relaxed">
            Junte-se ao ProService para se conectar com milhares de clientes e
            expandir seu negócio. Plano PRO por apenas R$ 10/mês.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-6 pt-4">
            <Link href="/login?tab=register">
              <Button
                size="lg"
                className="rounded-2xl h-16 px-12 text-lg font-black bg-primary hover:bg-accent shadow-xl shadow-primary/20 transition-transform active:scale-95"
              >
            ...
            <Button
              size="lg"
              variant="outline"
              className="rounded-2xl h-16 px-12 text-lg font-bold border-primary/20 hover:bg-white"
            >
              Saiba Mais
            </Button>
          </div>
      ...
      <footer className="w-full py-12 px-6 border-t border-muted/20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center opacity-50 grayscale">
            ...
            />
            <span className="ml-2 font-bold tracking-tighter text-xs">
              &copy; 2026
            </span>
          </div>
