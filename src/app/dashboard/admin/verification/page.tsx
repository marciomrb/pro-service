        ...
        {pendingProviders.length === 0 ? (
          <Card className="p-12 flex flex-col items-center justify-center text-center gap-4 rounded-3xl border-dashed">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Não há solicitações de verificação pendentes no momento.
              </p>
            </div>
          </Card>
        ) : (
          pendingProviders.map((item: any) => (
            <Card
              ...
              className="p-6 rounded-3xl border-border/50 hover:border-primary/50 transition-colors shadow-sm overflow-hidden relative group"
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  >
                    <Link
                      href={`/dashboard/admin/verification/${item.provider_id}`}
                    >
                      Analisar
