  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="p-6 bg-linear-to-br from-green-500/5 to-transparent border-green-500/10">
          <div className="flex items-center gap-4">
        ...
        <Card className="p-6 bg-linear-to-br from-blue-500/5 to-transparent border-blue-500/10">
          <div className="flex items-center gap-4">
              ...
              <Card className="border-border shadow-2xl p-6 bg-card">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <Input
                      value={selectedRequest?.requested_code}
                      disabled
